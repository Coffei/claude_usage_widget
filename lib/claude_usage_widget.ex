defmodule ClaudeUsageWidget do
  ...
  defp print_error(:not_found, mode) when mode in [:short, :argos, :json],
  ...
  defp print_error(:invalid_json, mode) when mode in [:short, :argos, :json],
  ...
  defp print_error({:missing_field, field}, mode) when mode in [:short, :argos, :json],
  ...
  defp print_error({:empty_field, field}, mode) when mode in [:short, :argos, :json],
  ...
  defp print_error(:unauthorized, mode) when mode in [:short, :argos, :json],
  ...
  defp print_error(:forbidden, mode) when mode in [:short, :argos, :json],
  ...
  defp print_error({:http_error, status, _body}, mode) when mode in [:short, :argos, :json],
  ...
  defp print_error({:request_failed, _exception}, mode) when mode in [:short, :argos, :json],
  ...
  defp print_error({:file_error, _reason}, mode) when mode in [:short, :argos, :json],
